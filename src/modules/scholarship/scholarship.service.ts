...
import { UpdateScholarshipDto } from '@/modules/scholarship/dtos/update-scholarship.dto'
import { validateScholarshipDuration } from '@/core/utils/date.util'
import { CountScholarshipsAsReportBetweenDatesDto } from '@/modules/scholarship/dtos/count-scholarship-courses-between-dates.dto'
import { ProgramEnum } from '@/core/enums/program.enum'
import {
...
import { ProcessedScholarship } from '@/modules/data-manager/update-scholarship-csv.util'
