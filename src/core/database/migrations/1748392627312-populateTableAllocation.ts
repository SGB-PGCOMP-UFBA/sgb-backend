...
export class PopulateTableAllocation1748392627312
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO allocation (name) VALUES ('SALA 12 - IC')`
    )
    await queryRunner.query(
      `INSERT INTO allocation (name) VALUES ('LABORATORIO DE PROFESSOR')`
    )
  }
